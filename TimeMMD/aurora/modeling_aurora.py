...
class AuroraModel(nn.Module):
    ...
    def forward(
        ...
        #print('vision_guider_inputembed:', inputs_embeds.shape)
        #print('vision_guider_visionfeature:', vision_features.shape)
        ...
        if text_input_ids is not None:
            ...
            #print('text_guider_textfeature:', text_features.shape)
        ...
        #print('connector x_enc:', x_enc.shape)
        #print('connector text:', text_features.shape)
        #print('connector vision:', vision_features.shape)
