...
from .skeinformer import skeinCrossTransformerEncoder, skeinCrossTransformerEncoderLayer
...
class VisionEncoder(nn.Module):
    ...
    def __init__(self, config: AuroraConfig):
        ...
        self.cross_vision = skeinCrossTransformerEncoder(
            skeinCrossTransformerEncoderLayer(
    ...
    def forward(self, x, type='pseudo'):
        ...
        #print(target_vision_tokens.shape)
...
class TextEncoder(nn.Module):
    ...
    def __init__(self, config: AuroraConfig):
        ...
        self.cross_text = skeinCrossTransformerEncoder(
            skeinCrossTransformerEncoderLayer(
                d_model=config.hidden_size,
                nhead=config.num_attention_heads,
                dim_feedforward=config.intermediate_size,
...
class ModalityConnector(nn.Module):
    def __init__(self, config: AuroraConfig):
        ...
        # Define learnable target tokens (shape: [num_distill_tokens, hidden_size])
        self.connect_text = skeinCrossTransformerEncoder(
            skeinCrossTransformerEncoderLayer(
                d_model=config.hidden_size,
                nhead=config.num_attention_heads,
                dim_feedforward=config.intermediate_size,
        ...
        self.connect_vision = skeinCrossTransformerEncoder(
            skeinCrossTransformerEncoderLayer(
                d_model=config.hidden_size,
                nhead=config.num_attention_heads,
                dim_feedforward=config.intermediate_size,
