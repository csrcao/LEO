...
from .prob_attention import InformerCrossTransformerEncoder, InformerCrossTransformerEncoderLayer
...
class VisionEncoder(nn.Module):
    ...
    def __init__(self, config: AuroraConfig):
        ...
        self.cross_vision = InformerCrossTransformerEncoder(
            InformerCrossTransformerEncoderLayer(
    ...
    def forward(self, x, type='pseudo'):
        ...
        #print('target_vision_tokens', target_vision_tokens.shape)
...
class TextEncoder(nn.Module):
    ...
    def __init__(self, config: AuroraConfig):
        ...
        self.cross_text = InformerCrossTransformerEncoder(
            InformerCrossTransformerEncoderLayer(
                d_model=config.hidden_size,
                nhead=config.num_attention_heads,
                dim_feedforward=config.intermediate_size,
    ...
    def forward(self, texts):
        ...
        #print('target_text_tokens', target_text_tokens.shape)
        #print('fixed_features', fixed_features.shape)
...
class ModalityConnector(nn.Module):
    def __init__(self, config: AuroraConfig):
        ...
        # Define learnable target tokens (shape: [num_distill_tokens, hidden_size])
        self.connect_text = InformerCrossTransformerEncoder(
            InformerCrossTransformerEncoderLayer(
                d_model=config.hidden_size,
                nhead=config.num_attention_heads,
                dim_feedforward=config.intermediate_size,
        ...
        self.connect_vision = InformerCrossTransformerEncoder(
            InformerCrossTransformerEncoderLayer(
                d_model=config.hidden_size,
                nhead=config.num_attention_heads,
                dim_feedforward=config.intermediate_size,
